...
- **[2026-04-20] v1.5.4.5 稳定增强版**：全量适配 Android 7.0+ 安装流程，修复下载完成后准备安装时的闪退；开放更新组件字段权限，根除 `IllegalAccessError`。
- **[2026-04-20] v1.5.4.4.4.4 稳定增强版**：新增“智能红点”纠错逻辑，确保更新后红点自动消失；修复检查更新时的 `IllegalAccessError` 闪退；修复最新版下无更新提示的问题。
- **[2026-04-19] v1.5.3.4.4.3 架构适配版**：实现 Android 16 底部留隙修复；完成“动画分流”判定逻辑；补齐自定义图标管理；全量中英文本地化支持。
