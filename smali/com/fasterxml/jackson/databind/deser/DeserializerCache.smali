...
.method private modifyTypeByAnnotation(Lcom/fasterxml/jackson/databind/DeserializationContext;Lcom/fasterxml/jackson/databind/introspect/Annotated;Lcom/fasterxml/jackson/databind/JavaType;)Lcom/fasterxml/jackson/databind/JavaType;
    ...
    .line 490
    .local v6, "kdDef":Ljava/lang/Object;
    if-eqz v6, :cond_1

    .line 491
    invoke-virtual {p1, p2, v6}, Lcom/fasterxml/jackson/databind/DeserializationContext;->keyDeserializerInstance(Lcom/fasterxml/jackson/databind/introspect/Annotated;Ljava/lang/Object;)Lcom/fasterxml/jackson/databind/KeyDeserializer;
    ...
    .end local p3    # "type":Lcom/fasterxml/jackson/databind/JavaType;
    invoke-virtual {p3, v5}, Lcom/fasterxml/jackson/databind/type/MapLikeType;->withKeyValueHandler(Ljava/lang/Object;)Lcom/fasterxml/jackson/databind/type/MapLikeType;
    ...
    .end local v6    # "kdDef":Ljava/lang/Object;
    ...
    instance-of v9, v2, Lcom/fasterxml/jackson/databind/JsonDeserializer;
    ...
    invoke-virtual {v4, v9, p2, p3}, Lcom/fasterxml/jackson/databind/AnnotationIntrospector;->refineDeserializationType(Lcom/fasterxml/jackson/databind/cfg/MapperConfig;Lcom/fasterxml/jackson/databind/introspect/Annotated;Lcom/fasterxml/jackson/databind/JavaType;)Lcom/fasterxml/jackson/databind/JavaType;
    ...
    .line 524
    .end local p3    # "type":Lcom/fasterxml/jackson/databind/JavaType;
    .restart local v8    # "type":Lcom/fasterxml/jackson/databind/JavaType;
    goto :goto_0

    .line 508
    .end local v8    # "type":Lcom/fasterxml/jackson/databind/JavaType;
    .restart local v0    # "cd":Lcom/fasterxml/jackson/databind/JsonDeserializer;, "Lcom/fasterxml/jackson/databind/JsonDeserializer<*>;"
    .restart local v2    # "cdDef":Ljava/lang/Object;
    .restart local p3    # "type":Lcom/fasterxml/jackson/databind/JavaType;
    :cond_4
    const-string v9, "findContentDeserializer"

    const-class v10, Lcom/fasterxml/jackson/databind/JsonDeserializer$None;

    invoke-direct {p0, v2, v9, v10}, Lcom/fasterxml/jackson/databind/deser/DeserializerCache;->_verifyAsClass(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/Class;)Ljava/lang/Class;

    move-result-object v1

    .line 509
    .local v1, "cdClass":Ljava/lang/Class;, "Ljava/lang/Class<*>;"
    if-eqz v1, :cond_2
...
.method protected _createAndCache2(Lcom/fasterxml/jackson/databind/DeserializationContext;Lcom/fasterxml/jackson/databind/deser/DeserializerFactory;Lcom/fasterxml/jackson/databind/JavaType;)Lcom/fasterxml/jackson/databind/JsonDeserializer;
    ...
    invoke-static {p1, v4, v2}, Lcom/fasterxml/jackson/databind/JsonMappingException;->from(Lcom/fasterxml/jackson/databind/DeserializationContext;Ljava/lang/String;Ljava/lang/Throwable;)Lcom/fasterxml/jackson/databind/JsonMappingException;
...
.method protected _handleUnknownValueDeserializer(Lcom/fasterxml/jackson/databind/DeserializationContext;Lcom/fasterxml/jackson/databind/JavaType;)Lcom/fasterxml/jackson/databind/JsonDeserializer;
    ...
    .line 579
    const-string v1, "Can not find a Value deserializer for abstract type %s"
    ...
    .line 581
    :cond_0
    const-string v1, "Can not find a Value deserializer for type %s"
