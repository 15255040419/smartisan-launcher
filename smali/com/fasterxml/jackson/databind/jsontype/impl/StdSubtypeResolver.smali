...
.method protected _collectAndResolve(Lcom/fasterxml/jackson/databind/introspect/AnnotatedClass;Lcom/fasterxml/jackson/databind/jsontype/NamedType;Lcom/fasterxml/jackson/databind/cfg/MapperConfig;Lcom/fasterxml/jackson/databind/AnnotationIntrospector;Ljava/util/HashMap;)V
    ...
    invoke-static {v1, p3}, Lcom/fasterxml/jackson/databind/introspect/AnnotatedClass;->constructWithoutSuperTypes(Ljava/lang/Class;Lcom/fasterxml/jackson/databind/cfg/MapperConfig;)Lcom/fasterxml/jackson/databind/introspect/AnnotatedClass;
...
.method public collectAndResolveSubtypesByClass(Lcom/fasterxml/jackson/databind/cfg/MapperConfig;Lcom/fasterxml/jackson/databind/introspect/AnnotatedMember;Lcom/fasterxml/jackson/databind/JavaType;)Ljava/util/Collection;
    ...
    invoke-static {v2, v0}, Lcom/fasterxml/jackson/databind/introspect/AnnotatedClass;->constructWithoutSuperTypes(Ljava/lang/Class;Lcom/fasterxml/jackson/databind/cfg/MapperConfig;)Lcom/fasterxml/jackson/databind/introspect/AnnotatedClass;
...
.method public collectAndResolveSubtypesByTypeId(Lcom/fasterxml/jackson/databind/cfg/MapperConfig;Lcom/fasterxml/jackson/databind/introspect/AnnotatedClass;)Ljava/util/Collection;
    ...
    .line 166
    .local v4, "typesHandled":Ljava/util/Set;, "Ljava/util/Set<Ljava/lang/Class<*>;>;"
    new-instance v5, Ljava/util/LinkedHashMap;

    invoke-direct {v5}, Ljava/util/LinkedHashMap;-><init>()V

    .line 168
    .local v5, "byName":Ljava/util/Map;, "Ljava/util/Map<Ljava/lang/String;Lcom/fasterxml/jackson/databind/jsontype/NamedType;>;"
    ...
    .local v7, "curr":Lcom/fasterxml/jackson/databind/introspect/AnnotatedClass;
    move-object v6, p0
    ...
    .line 181
    .end local v7    # "curr":Lcom/fasterxml/jackson/databind/introspect/AnnotatedClass;
...
.method public collectAndResolveSubtypesByTypeId(Lcom/fasterxml/jackson/databind/cfg/MapperConfig;Lcom/fasterxml/jackson/databind/introspect/AnnotatedMember;Lcom/fasterxml/jackson/databind/JavaType;)Ljava/util/Collection;
    ...
    .line 132
    .local v6, "typesHandled":Ljava/util/Set;, "Ljava/util/Set<Ljava/lang/Class<*>;>;"
    new-instance v7, Ljava/util/LinkedHashMap;

    invoke-direct {v7}, Ljava/util/LinkedHashMap;-><init>()V

    .line 135
    .local v7, "byName":Ljava/util/Map;, "Ljava/util/Map<Ljava/lang/String;Lcom/fasterxml/jackson/databind/jsontype/NamedType;>;"
    new-instance v4, Lcom/fasterxml/jackson/databind/jsontype/NamedType;
    ...
    .end local v4    # "rootType":Lcom/fasterxml/jackson/databind/jsontype/NamedType;
    .end local v6    # "typesHandled":Ljava/util/Set;, "Ljava/util/Set<Ljava/lang/Class<*>;>;"
    .end local v7    # "byName":Ljava/util/Map;, "Ljava/util/Map<Ljava/lang/String;Lcom/fasterxml/jackson/databind/jsontype/NamedType;>;"
    .end local v10    # "nt":Lcom/fasterxml/jackson/databind/jsontype/NamedType;
    .end local v18    # "i$":Ljava/util/Iterator;
    .end local v19    # "rawBase":Ljava/lang/Class;, "Ljava/lang/Class<*>;"
    .end local v20    # "st":Ljava/util/Collection;, "Ljava/util/Collection<Lcom/fasterxml/jackson/databind/jsontype/NamedType;>;"
    :cond_0
    invoke-virtual/range {p3 .. p3}, Lcom/fasterxml/jackson/databind/JavaType;->getRawClass()Ljava/lang/Class;
    ...
    .line 149
    .restart local v3    # "ac":Lcom/fasterxml/jackson/databind/introspect/AnnotatedClass;
    .restart local v4    # "rootType":Lcom/fasterxml/jackson/databind/jsontype/NamedType;
    .restart local v6    # "typesHandled":Ljava/util/Set;, "Ljava/util/Set<Ljava/lang/Class<*>;>;"
    .restart local v7    # "byName":Ljava/util/Map;, "Ljava/util/Map<Ljava/lang/String;Lcom/fasterxml/jackson/databind/jsontype/NamedType;>;"
    .restart local v19    # "rawBase":Ljava/lang/Class;, "Ljava/lang/Class<*>;"
    .restart local v20    # "st":Ljava/util/Collection;, "Ljava/util/Collection<Lcom/fasterxml/jackson/databind/jsontype/NamedType;>;"
    :cond_1
    move-object/from16 v0, p0
    ...
    invoke-virtual {v0, v6, v7}, Lcom/fasterxml/jackson/databind/jsontype/impl/StdSubtypeResolver;->_combineNamedAndUnnamed(Ljava/util/Set;Ljava/util/Map;)Ljava/util/Collection;
